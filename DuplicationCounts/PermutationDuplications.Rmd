...
duplications <- duplications %>% select(-c(pi300119, sweetAVG, biomassAVG, distance))
...
testing <- chr1 %>% filter(interval==49) %>% mutate(category = ifelse(strain %in% c("rio", "leoti", "CA"), "sweet", "biomass"))
