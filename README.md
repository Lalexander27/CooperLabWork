...
5) Next, I [annotated](GeneAnnotations/GenesInInterval.py) these significant intervals for gene location info, and marked associated [GO terms](GeneAnnotations/GOAnalyses.Rmd) and functions in arabidopsis and rice genomes.  
